            ...
            if(k<len(PARCEL_CLASS_LIST)-1):
                ...
                try:
                    ...
                    if(d_root<=A.by  or d_root<=A.ax and (A.ax==B.ax and A.by==B.by)):
                        ...
                        if(n<2 and A.ax<CELL_LENGTH*8 and A.by<CELL_WIDTH*8):
                            req_l=CELL_LENGTH*4
                            req_b=CELL_WIDTH*4
...
ui.panel.addLabel("", "min=5  max=55  default=10",(150,100,100), True)
ui_OUTPUT_IMG_TIME=ui.panel.addTrackBar("",5,55,5,10,10,10,500,True, None)
